...
# get the data
setwd("D:/1 Study Material/US Electricity Price/")
...
plot(pred, showgap = FALSE, PI = FALSE, xlab = "from 2000 to 2026", ylab = "Electricity Price (in cents/kWh)",
